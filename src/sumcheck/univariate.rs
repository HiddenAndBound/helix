...
mod tests {
    ...
    fn test_polynomial_addition() {
        ...
        let poly2 =
            UnivariatePolynomial::new(vec![Fp::from_u32(3), Fp::from_u32(4), Fp::from_u32(5)]);

        let sum = poly1.add(&poly2);
        assert_eq!(
            sum.coefficients(),
            &[Fp::from_u32(4), Fp::from_u32(6), Fp::from_u32(5)]
        );
    }
    ...
    fn test_polynomial_multiplication() {
        ...
        assert_eq!(
            ...
            &[Fp::from_u32(3), Fp::from_u32(10), Fp::from_u32(8)]
        );
    }
    ...
    fn test_polynomial_interpolation() {
        ...
        let poly = UnivariatePolynomial::<Fp>::interpolate(&points, &values).unwrap();
